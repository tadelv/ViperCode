 ...
 */
-(NSString*)featchUserNameFromAddressBook {
...
-(void)fireGenerateAction:(BOOL)replaceExistedModule replaceExsitedModuleTest:(BOOL)replaceExsitedModuleTest
{
    ...
    NSString *userName = [self featchUserNameFromAddressBook];
...
{
    //Chekc if user selected Include unite tests option and did not enered test file path.
...
- (void)controlTextDidChange:(NSNotification *)notification {
    ...
    //jsut show NSOpenPanel if editing Module File Path textfield. 
